  ...
  return (
    <>
      <div className="relative w-full h-70 sm:h-80 md:h-100 lg:h-120">
        <img src="/src/assets/gen4.jpg" className="w-full h-full object-cover opacity-70" alt='Background Image' loading='lazy'/>
        <div className="absolute inset-0 flex flex-col md:flex-row items-start p-4 sm:p-6 md:p-8 lg:p-10 md:justify-between justify-start">
          <img src="/src/assets/LogiNOW_WHITE-removebg-preview.png" className="w-20 sm:w-32 md:w-48 lg:w-56 h-auto mb-4 md:mb-0 pointer-events-none select-none" alt='Logo' loading='lazy'/>
      ...
      <div className='w-full flex flex-col md:flex-row justify-around gap-6 px-4 md:px-0'>
        <div className='flex flex-col items-center bg-white p-4 md:p-6 w-full md:w-1/4'>
          <img src="/src/assets/png-truck-icon.png" className='w-22 sm:w-26 md:w-30 lg:w-34 h-auto pointer-events-none select-none' alt='Truck Icon' loading='lazy'/>
        ...
        <div className='flex flex-col items-center bg-white p-4 md:p-6 w-full md:w-1/4'>
          <img src="/src/assets/location-icon-png.png" className='w-22 sm:w-26 md:w-30 lg:w-34 h-auto pointer-events-none select-none' alt='Location Icon' loading='lazy'/>
        ...
        <div className='flex flex-col items-center bg-white p-4 md:p-6 w-full md:w-1/4'>
          <img src="/src/assets/freight-icon.png" className='w-22 sm:w-26 md:w-30 lg:w-34 h-auto pointer-events-none select-none' alt='Freight Icon' loading='lazy'/>
      ...
      <div className="w-full flex flex-col lg:flex-row gap-6 lg:gap-8 mt-10 px-4 md:px-6 lg:px-10 mb-10">
        <div className="flex flex-col gap-6 lg:w-1/2">
          ...
          <div className="bg-[#F0F0F0] rounded-xl p-5 flex flex-col items-center justify-center">
            ...
            <div className='flex'>
              <img src="/src/assets/free-phone-icon-1-thumb.png" className="w-6 sm:w-8 md:w-9 lg:w-10 h-auto mt-4 mb-4" alt="Phone Icon" loading='lazy'/>
      ...
      <footer>
        <div className="w-full bg-[#D9D9D9] text-white py-2 flex flex-col md:flex-row justify-between items-center px-4 md:px-10">
          <img src="/src/assets/LogiNOW_WHITE-removebg-preview.png" className="w-24 sm:w-32 md:w-40 h-auto mb-4 md:mb-0" alt='Logo' loading='lazy'/>
